...
var _addStudents = require("./addStudents");
var _deleteStudents = require("./deleteStudents");
var _creatStudent = require("./creatStudent");
var _updateStudent = require("./updateStudent");
document.querySelector("#get-students-btn").addEventListener("click", ()=>{
    (0, _getStudents.getStudents)().then((students)=>{
        document.querySelector(".studentds-list").innerHTML = (0, _creatStudent.creatStudent)(students);
    });
});
...
document.querySelector("#edit-student-form").addEventListener("submit", (event)=>{
    ...
    (0, _updateStudent.updateStudents)(studentEditId, newUpdateStudent).then(()=>(0, _getStudents.getStudents)()).then((students)=>{
        document.querySelector(".studentds-list").innerHTML = (0, _creatStudent.creatStudent)(students);
...
document.addEventListener("click", (event)=>{
    if (event.target.classList.contains("delete")) {
        const studentId = event.target.dataset.id;
        (0, _deleteStudents.deleteStudents)(studentId).then(()=>{
            (0, _getStudents.getStudents)().then((students)=>{
                document.querySelector(".studentds-list").innerHTML = (0, _creatStudent.creatStudent)(students);
            });
        });
...
document.querySelector("#add-student-form").addEventListener("submit", (event)=>{
    ...
    (0, _addStudents.addStudent)(newPostStudent);
    (0, _getStudents.getStudents)().then((students)=>{
        document.querySelector(".studentds-list").innerHTML = (0, _creatStudent.creatStudent)(students);
    });
...
},{"./getStudents":"1HYqm","./addStudents":"i95wQ","./deleteStudents":"kvimH","./creatStudent":"aapS5","./updateStudent":"cHHOw"}],"1HYqm":[function(require,module,exports,__globalThis) {
...
},{}],"i95wQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const addStudent = (newStudent)=>{
    ...
    return fetch("http://localhost:3000/students", options).then((response)=>response.json(""));
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kvimH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteStudents", ()=>deleteStudents);
const deleteStudents = (studentDel)=>{
    const options = {
        method: "DELETE",
    ...
    return fetch(`http://localhost:3000/students/${studentDel}`, options).then((response)=>response.json());
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aapS5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "creatStudent", ()=>creatStudent);
const creatStudent = (students)=>students.map((student)=>`<tr>
...
const updateStudents = (studentId, studentUpdate)=>{
    const options = {
        method: "PATCH",
    ...
    return fetch(`http://localhost:3000/students/${studentId}`, options).then((response)=>response.json());
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirec054", {})

//# sourceMappingURL=crud-with-backend-hw.31b563d9.js.map
